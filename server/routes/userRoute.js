...
router.post("/login", async (req, res) => {
  try {
    ...
    if (passwordsMatched) {
      //if passwords are matched then we are generating the token by encrypting the token id and we are sending the encrypted token which has userid to the frontend
      //jwt authentication
